...
pyinstaller app.py --name F1Laps --noconsole --icon=images/app-icon.icns

# If you need to specifiy a certain Python version
python3 -m PyInstaller app.py --name F1Laps --noconsole --icon=images/app-icon.icns
```

**Windows** 

```bash
pyinstaller app.py --onefile --name F1Laps --noconsole --icon=images/app-icon.ico
```
